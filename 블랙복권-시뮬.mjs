...
//  - index.html BLACK_TIER 파라미터와 일치: price700·winChance0.31·happyChance0.10·happyWinChance0.01·potRate140(20%)·skulls2×-20.
...
const PRICE=700, POT_RATE=140, TRANSFORM=0.10, POT_WIN=0.01;
const NORM_WIN=0.31, SKULLS=2, PEN=20, PITY_CAP=20;
