...
### v2.45.569 (2026-07-07·원격web·작업브랜치 `claude/continued-update-1srahn`) — 🗡️ 투기장 강화 확률 단조 정상화 + 초반 난이도 하향 ← 최신
