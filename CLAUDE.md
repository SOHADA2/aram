...
### v2.45.545~547 (2026-07-03·로컬 PC) — ⚡ 팀짜기/타이머 버벅임 + 정산창 지연 + 정산 후 메인 복귀 + 아코디언 유지 + 🕹️인형뽑기 시점 ← 최신
