...
### v2.45.573~575 (2026-07-08·다른 PC) — 🖥️ 오버레이 정산 발행 + 🔒 계정 조작 잠금(B안) + 🪟 시즌팝업 스크롤 ← 최신
