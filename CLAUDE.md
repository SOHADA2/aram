...
### v2.45.570 (2026-07-08·원격web·작업브랜치 `claude/continued-update-1srahn`) — 🗡️ 투기장 배틀 정찰 어뷰즈 차단(대결 시작 시점 커밋) ← 최신
