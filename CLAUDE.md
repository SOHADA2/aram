...
### v2.45.337~369 (2026-06-26~27) — 🗡️ 인형 투기장 대장정(강화/판매/배틀/3D 전투/코인경제) + 경제 시뮬 검증 + 데이터 복원 ← 최신
