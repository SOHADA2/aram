...
### v2.45.302 + 인형뽑기 BUILD 149 (2026-06-25) — 🕹️ 인형뽑기 코인/기회 헛소모 방지(로딩 게이트+이탈 확인창) + 보상 + 🧸 단짝 desc 정정 ← 최신
