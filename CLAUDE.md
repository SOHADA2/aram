...
### v2.45.627 (2026-07-27·이 PC·`main` 직접) — 🐱 유미 휴식(쿨다운) 완전 제거·강철심장 유미효과 통합 + 🎓 변신 진행도 안내 ← 최신
