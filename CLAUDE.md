...
### v2.45.624 (2026-07-27·이 PC·`main` 직접) — 🌃 「뒷골목으로 나가기」 드래그 시 화면 스크롤/튐 수정(스크롤 잠금) ← 최신
